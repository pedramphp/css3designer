				...
				return {
					...
					getBorder:function(){						
						...
						return {
							load: function(){ 	
								...
								that.colorPicker( tabSettings.border.borderColor, tabSettings.style.borderColor, 'borderColor');
								that.slider( tabSettings.border.borderWidth, tabSettings.style.borderWidth, 'borderWidth', 0, 10 );
								that.slider( tabSettings.border.borderRadius, tabSettings.style.borderRadius, 'borderRadius',0,45 );
					...
					getBox: function(){
						...
						return {
							...
							load: function(){
								...
								that.slider( box.transform, style.boxTransform,'boxTransform',0,360 );
								
								var paddings = style.padding.split(" ");
								that.slider( box.paddingHorizontal, paddings[0], 'padding', 0, 150 );
								that.slider( box.paddingVertical, paddings[1], 'padding', 0, 150 );
								
								var styles = style.boxShadow.split(" ");
								that.slider( box.boxShadowHl, styles[0], 'boxShadow', 0, 20 );
								that.slider( box.boxShadowVl, styles[1], 'boxShadow', 0, 20 );
								that.slider( box.boxShadowBr, styles[2], 'boxShadow', 0, 100);
								that.colorPicker( box.boxShadowSc, styles[3],'boxShadow'); 
							}
						}
					},/* </ getBox > */
					...
					getText: function(){
						...
						return {
							...
							load: function(){ 
								that.colorPicker( tabSettings.text.color, tabSettings.style.color,'color');
								...
								that.select( tabSettings.text.decoration, tabSettings.style.textDecoration,'textDecoration');
								that.select( tabSettings.text.transform, tabSettings.style.textTransform,'textTransform');
								that.select( tabSettings.text.fontFamily, tabSettings.style.fontFamily,'fontFamily');
								that.select( tabSettings.text.fontWeight, tabSettings.style.fontWeight,'fontWeight');
					...
					getBackground: function(){
						...
						return {
							...
							load: function(){
								that.colorPicker( tabSettings.background.color, tabSettings.style.backgroundColor,'backgroundColor');										
								var style;	
